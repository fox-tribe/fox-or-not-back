...
class Like(models.Model):
    like_user = models.ForeignKey('user.User', verbose_name="투표한 유저", on_delete=models.CASCADE)
    ...
    def __str__(self, request):
       return f"{self.like_user}님이 {self.like_comment}{self.like_article}에 {self.like_category}공감했습니다."
